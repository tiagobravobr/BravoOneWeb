...
const MinimalContentNavigation: React.FC = () => {
  ...
  return (
    <div className="w-64 pr-6 border-r border-gray-800/50">
      <div className="space-y-1">
        {mockModules.map((module) => (
          <div key={module.id} className="space-y-0.5">
            {/* Cabeçalho do Módulo - Minimalista */}
            <div
              className="flex items-center gap-2 py-1 cursor-pointer group text-sm"
            ...
            {expandedModules.has(module.id) && (
              <div className="ml-5 space-y-0.5">
                {module.pages.map((page) => (
                  <div
                    key={page.id}
                    className="flex items-center gap-2 py-1 cursor-pointer group text-sm hover:text-white transition-colors"
                  >
...
export default MinimalContentNavigation
